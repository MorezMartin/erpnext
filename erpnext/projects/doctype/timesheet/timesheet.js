...
frappe.ui.form.on("Timesheet", {
	setup: function (frm) {
		...
		frm.ignore_doctypes_on_cancel_all = ["Sales Invoice", "Sales Order", "Timesheet", "Production Plan", "Material Request", "Delivery Note", "Repost Item Valuation", "Shift Request", "Shift Assignment", "Journal Entry"];
